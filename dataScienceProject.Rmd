...
```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "50"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table2 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table2[i,1] <- details$businesses[[i]]$name
   san_francisco_table2[i,2] <- details$businesses[[i]]$rating
   san_francisco_table2[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table2[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table2[i,5] <- details$businesses[[i]]$price
   san_francisco_table2[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table2[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "100"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table3 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table3[i,1] <- details$businesses[[i]]$name
   san_francisco_table3[i,2] <- details$businesses[[i]]$rating
   san_francisco_table3[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table3[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table3[i,5] <- details$businesses[[i]]$price
   san_francisco_table3[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table3[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "150"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table4 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table4[i,1] <- details$businesses[[i]]$name
   san_francisco_table4[i,2] <- details$businesses[[i]]$rating
   san_francisco_table4[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table4[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table4[i,5] <- details$businesses[[i]]$price
   san_francisco_table4[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table4[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "200"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table5 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table5[i,1] <- details$businesses[[i]]$name
   san_francisco_table5[i,2] <- details$businesses[[i]]$rating
   san_francisco_table5[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table5[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table5[i,5] <- details$businesses[[i]]$price
   san_francisco_table5[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table5[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "250"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table6 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table6[i,1] <- details$businesses[[i]]$name
   san_francisco_table6[i,2] <- details$businesses[[i]]$rating
   san_francisco_table6[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table6[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table6[i,5] <- details$businesses[[i]]$price
   san_francisco_table6[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table6[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "300"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table7 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table7[i,1] <- details$businesses[[i]]$name
   san_francisco_table7[i,2] <- details$businesses[[i]]$rating
   san_francisco_table7[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table7[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table7[i,5] <- details$businesses[[i]]$price
   san_francisco_table7[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table7[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "350"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table8 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table8[i,1] <- details$businesses[[i]]$name
   san_francisco_table8[i,2] <- details$businesses[[i]]$rating
   san_francisco_table8[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table8[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table8[i,5] <- details$businesses[[i]]$price
   san_francisco_table8[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table8[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "400"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table9 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table9[i,1] <- details$businesses[[i]]$name
   san_francisco_table9[i,2] <- details$businesses[[i]]$rating
   san_francisco_table9[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table9[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table9[i,5] <- details$businesses[[i]]$price
   san_francisco_table9[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table9[i,7] <- all_cats
  }
```

```{r}
san_francisco <- GET("https://api.yelp.com/v3/businesses/search?",
              query = list(location = "San Francisco", price = "1,2,3,4", limit = "50", offset = "450"),
              add_headers(Authorization = "Bearer xEc4HGvGXUa5hzIiVTxBlbkfHRogq_QZRiIwbmEyo5MROFTISNg2zDn60UnEADRJA8hU4KMbkzfCIrgh2p6C9RvAJouRwxnrFf_NHtlYjFuUjPXla9vsJNb3hTvrW3Yx"))

  details <- content(san_francisco, "parse")
  
  san_francisco_table10 <- tibble( Name = character(), Rating = double(), latitude = double(), longitude = double(), price = character(), review_count = integer(), categories = character())
  
  for(i in 1:length(details$businesses)){
   san_francisco_table10[i,1] <- details$businesses[[i]]$name
   san_francisco_table10[i,2] <- details$businesses[[i]]$rating
   san_francisco_table10[i,3] <- details$businesses[[i]]$coordinates$latitude
   san_francisco_table10[i,4] <- details$businesses[[i]]$coordinates$longitude
   san_francisco_table10[i,5] <- details$businesses[[i]]$price
   san_francisco_table10[i,6] <- details$businesses[[i]]$review_count
   cats <- vector()
   for(j in details$businesses[[i]]$categories){
    cats <- append(cats,j$title)
   }
   all_cats <- paste(cats, collapse = ' ')
   cats <- vector()
   san_francisco_table10[i,7] <- all_cats
  }
```
...
```{r, newyorkmerge}
  ...
  san_francisco_final <- bind_rows(san_francisco_table1, san_francisco_table2, san_francisco_table3, san_francisco_table4, 
                              san_francisco_table5, san_francisco_table6, san_francisco_table7, 
                              san_francisco_table8, san_francisco_table9, san_francisco_table10)
  ...
  # write.csv(san_francisco_final, file = "san_francisco_final.csv")
