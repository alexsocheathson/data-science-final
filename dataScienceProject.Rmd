...
seattle_box <- c(left = min(seattle_table$longitude), bottom = min(seattle_table$latitude)), right = max(seattle_table$longitude), top = max(seattle_table$latitude))

seattle_map <- get_stamenmap(seattle_box, zoom = 12, maptype - "toner-lite")
ggmap(seattle_map)
